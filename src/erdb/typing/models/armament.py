...
class AffinityProperties:
    ...
    guard: Guard = Field(
        ...
        example=Guard(
            physical=65, magic=35, fire=35, lightning=35, holy=35, guard_boost=42
        ),
    )
    ...
    status_effect_overlay: list[StatusEffects] = Field(
        ...
        max_items=26,
        example=[
            StatusEffects(poison=80),
            StatusEffects(poison=81),
            StatusEffects(poison=82),
            StatusEffects(poison=84),
            StatusEffects(poison=85),
            StatusEffects(poison=87),
            StatusEffects(poison=88),
            StatusEffects(poison=89),
            StatusEffects(poison=91),
            StatusEffects(poison=92),
            StatusEffects(poison=94),
            StatusEffects(poison=95),
            StatusEffects(poison=96),
            StatusEffects(poison=98),
            StatusEffects(poison=99),
            StatusEffects(poison=101),
            StatusEffects(poison=102),
            StatusEffects(poison=103),
            StatusEffects(poison=105),
            StatusEffects(poison=106),
            StatusEffects(poison=108),
            StatusEffects(poison=109),
            StatusEffects(poison=110),
            StatusEffects(poison=112),
            StatusEffects(poison=113),
            StatusEffects(poison=115),
        ],
    )
